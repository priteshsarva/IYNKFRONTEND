...
const Home = () => {
    ...
    const fromHandle = (e) => {
        ...
        fetch(url + url2, {
            ...
            body: JSON.stringify({ cname, curl, youtubecategory, vtitle, vurl }), // string, FormData, Blob, BufferSource, or URLSearchParams
        }).then(async (res) => {
    ...
    const fromHandleUpdate = (e) => {
        ...
        var datatoUpdate = {}
        if (cname) {
            datatoUpdate.youtubeChannellName = cname
        }
        if (curl) {
            datatoUpdate.youtubeChannellURL = curl
        }
        datatoUpdate.youtubecategory = youtubecategory1
    ...
    return (
        <>
            ...
            <div className="container  mt-5 ">
                ...
                <h1 className="text-uppercase text-center">Youtube Channel List FOR IYNK</h1>
                ...
                <div className="container p-5 " style={{ width: '95%' }}>
                    ...
                    {idd === "edit" ? <>
                                        ...
                                        <>
                                            <div className="col-12 col-md-6 row border  mb-3" id={currentValue._id} style={{ cursor: "pointer" }} data-bs-toggle="modal" data-bs-target={`#staticBackdrop${currentValue._id}`} >
                                                ...
                                                <div className="col-4" id={currentValue._id}>
                                                    <img className="demo-bg" src={currentValue.profilePictureUrl} alt="" id={currentValue._id} />
                                                </div>

                                                <div className="customtabcontnet text-break col-8" id={currentValue._id} >
                                                    <h2 id={currentValue._id} style={{ color: '#0d6efd' }}>{currentValue.youtubeChannellName}</h2>
                                                    <h4 id={currentValue._id}>{

                                                        currentValue.youtubecategory.map((currentValuee, index, arr) => {
                                                            category.map(elem => {
                                                               
                                                                if (elem._id === currentValuee) {
                                                                    // console.log('elem : ',elem.categoryName );
                                                                    catlist = catlist + " " + elem.categoryName + ","
                                                                }
                                                            })
                                                            // var tc = currentValue.youtubecategory;
                                                            var size = Object.keys(currentValue.youtubecategory).length;
                                                ...
                                                <div className="modal-dialog modal-dialog-centered">
                                                    <div className="modal-content">
                                                        <div className="modal-header">
                                                            <h1 className="modal-title fs-5" id="staticBackdropLabel">{currentValue.youtubeChannellName}</h1>
                                                        ...
                                                        <form onSubmit={fromHandleUpdate}>
                                                            ...
                                                            <div className="modal-body">
                                                                ...
                                                                <div className="form-floating mb-3">
                                                                    <input type="text" className="form-control" id="floatingInput" placeholder={currentValue.youtubeChannellName} name='newname' />
                                                                    <label htmlFor="floatingInput">{currentValue.youtubeChannellName}</label>
                                                                </div>

                                                                <label htmlFor="exampleFormControlInput1" className="form-label">New Url</label>

                                                                <div className="form-floating mb-3">
                                                                    <input type="text" className="form-control" id="floatingInputurl" placeholder={currentValue.youtubeChannellURL} name='newurl' />
                                                                    <label htmlFor="floatingInputurl">{currentValue.youtubeChannellURL}</label>
                                                                </div>
                                                                    ...
                                                                    <div className="justify-content-between row row-cols-1 row-cols-md-2 g-2" style={{ flexDirection: "row", listStyle: "none" }}>
                                                                        {
                                                                            ...
                                                                            category.length === 0 ? <></> : category.map((item, index) => {
                                                                                ...
                                                                                currentValue.youtubecategory.map((check) => {
                        ...
                        <form className="" onSubmit={fromHandle} style={{ paddingTop: "3rem", paddingBottom: "3rem", paddingLeft: "5%", paddingRight: "5%" }}>
                            ...
                            <div className="mb-3">
                                <label htmlFor="exampleFormControlInput1" className="form-label">Channel name </label>
                                <input type="text" className="form-control" id="exampleFormControlInput1" placeholder="Name" name="cname" required />
                            </div>
                            <div className="mb-3">
                                <label htmlFor="exampleFormControlInput1" className="form-label">Channel URL</label>
                                <input type="text" className="form-control" id="exampleFormControlInput1" placeholder="www.youtube.com/@cokestudio" name="curl" required />
                            </div>
                            <div className="mb-3">
                                <label htmlFor="exampleFormControlInput1" className="form-label">latest Video Title</label>
                                <input type="text" className="form-control" id="exampleFormControlInput1" placeholder="10 ways to die" name="vtitle" />
                            </div>
                            <div className="mb-3">
                                <label htmlFor="exampleFormControlInput1" className="form-label">latest Video URL</label>
                                <input type="text" className="form-control" id="exampleFormControlInput1" placeholder="https://www.youtube.com/watch?v=warsegdrhdgry" name="vurl" />
                            </div>
...

                                    {
                                        ...
                                        category.length === 0 ? <></> : category.map((item, index) => {
                                            return <>
                                                <div>
                                                    <div className="col border" >
                                                        <input className="form-check-input me-1 categorycheckbox" type="checkbox" value="" id={item._id} />
                                                        <label className="form-check-label" htmlFor={item._id}>{item.categoryName}</label>
                                                    </div>
                                                </div>
                                            </>
